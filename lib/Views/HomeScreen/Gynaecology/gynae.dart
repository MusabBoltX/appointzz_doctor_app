...
class GynaeHome extends StatefulWidget {
  const GynaeHome({Key? key}) : super(key: key);

  @override
  _GynaeHomeState createState() => _GynaeHomeState();
}

class _GynaeHomeState extends State<GynaeHome> {
  ...
  int displayGynaeText = 0;

  void _plusCount() {
    setState(() {
      gynaeCounter = displayGynaeText;
    });
